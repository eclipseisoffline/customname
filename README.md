...
This mod requires the Fabric API, and is currently available for Minecraft 1.20.5, 1.20.1 and 1.19.4 (1.20.4 and 1.19.2 ports exist, but are no longer updated).
